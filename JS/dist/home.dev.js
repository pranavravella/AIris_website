...
function initialize() {
  ...
  setInterval(function () {
    ...
    prev = curr;
    var timewidth = $('.ourtimeline .timeline > :last-child').offset().left - $('.ourtimeline .timeline > :first-child').offset().left + $('.ourtimeline .timeline > :last-child').width();
    var linewidth = timewidth - $('.ourtimeline .timeline > :first-child').width() / 2 - $('.ourtimeline .timeline > :last-child').width() / 2;
  ...
  }, 100); //Timelines slider

  var slider = document.querySelector('.ourtimeline .pad');
  var isDown = false;
  var startX;
  var scrollLeft;
